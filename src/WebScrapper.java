...
public class WebScrapper
{
    ...
    public static List<String> nameList = Arrays.asList(" All", "Afar", "Abkhazian", "Acehnese", "Adyghe", "Afrikaans", "Alemannic", "Southern Altai", "Amharic", "Amis", "Aragonese", "Old English", "Obolo", "Angika", "Arabic", "Aramaic", "Moroccan Arabic", "Egyptian Arabic", "Assamese", "Asturian", "Atikamekw", "Avaric", "Kotava", "Awadhi", "Aymara", "Azerbaijani", "South Azerbaijani", "Bashkir", "Balinese", "Bavarian", "Samogitian", "Batak Toba", "Central Bikol", "West Coast Bajau", "Belarusian", "Belarusian (Taraškievica orthography)", "Betawi", "Bulgarian", "Bhojpuri", "Bislama", "Banjar", "Pa'O", "Bambara", "Bangla", "Tibetan", "Bishnupriya", "Breton", "Bosnian", "Batak Mandailing", "Buginese", "Russia Buriat", "Catalan", "Chavacano", "Mindong", "Chechen", "Cebuano", "Chamorro", "Cherokee", "Cheyenne", "Central Kurdish", "Corsican", "Crimean Tatar", "Czech", "Kashubian", "Church Slavic", "Chuvash", "Welsh", "Danish", "Dagbani", "German", "Southern Dagaare", "Dinka", "Dimli", "Lower Sorbian", "Central Dusun", "Doteli", "Divehi", "Dzongkha", "Ewe", "Greek", "Emiliano-Romagnolo", "English", "Esperanto", "Spanish", "Estonian", "Basque", "Extremaduran", "Persian", "Fanti", "Fula", "Finnish", "V\u00f5ro", "Fijian", "Faroese", "Fon", "French", "Arpitan", "Northern Frisian", "Friulian", "Western Frisian", "Irish", "Gagauz", "Gan", "Guianan Creole", "Scottish Gaelic", "Galician", "Gilaki", "Guarani", "Goan Konkani", "Gorontalo", "Gothic", "Ghanaian Pidgin", "Gujarati", "Wayuu", "Frafra", "Gun", "Manx", "Hausa", "Hakka Chinese", "Hawaiian", "Hebrew", "Hindi", "Fiji Hindi", "Croatian", "Upper Sorbian", "Haitian Creole", "Hungarian", "Armenian", "Western Armenian", "Interlingua", "Iban", "Indonesian", "Interlingue", "Igbo", "Igala", "Inupiaq", "Iloko", "Ingush", "Ido", "Icelandic", "Italian", "Inuktitut", "Japanese", "Jamaican Creole English", "Lojban", "Javanese", "Georgian", "Kara-Kalpak", "Kabyle", "Kabardian", "Kabiye", "Tyap", "Kongo", "Komering", "Kikuyu", "Kazakh", "Khmer", "Kannada", "Central Kanuri", "Korean", "Komi-Permyak", "Karachay-Balkar", "Kashmiri", "Colognian", "Kurdish", "Kusaal", "Komi", "Cornish", "Kyrgyz", "Latin", "Ladino", "Luxembourgish", "Lak", "Lezghian", "Lingua Franca Nova", "Ganda", "Limburgish", "Ligurian", "Ladin", "Lombard", "Lingala", "Lao", "Lithuanian", "Latgalian", "Latvian", "Literary Chinese", "Madurese", "Maithili", "Banyumasan", "Moksha", "Malagasy", "Eastern Mari", "Māori", "Minangkabau", "Macedonian", "Malayalam", "Mongolian", "Manipuri", "Mon", "Moldovan", "Mossi", "Marathi", "Western Mari", "Malay", "Maltese", "Mirandese", "Burmese", "Erzya", "Mazanderani", "Nahuatl", "Minnan", "Neapolitan", "Low German", "Low Saxon", "Nepali", "Newari", "Nias", "Dutch", "Norwegian Nynorsk", "Norwegian", "Novial", "N’Ko", "South Ndebele", "Norman", "Northern Sotho", "Nupe", "Navajo", "Nyanja", "Occitan", "Livvi-Karelian", "Oromo", "Odia", "Ossetic", "Punjabi", "Pangasinan", "Pampanga", "Papiamento", "Picard", "Nigerian Pidgin", "Pennsylvania German", "Palatine German", "Pali", "Polish", "Piedmontese", "Western Punjabi", "Pontic", "Pashto", "Portuguese", "Paiwan", "Quechua", "Arakanese", "Romansh", "Vlax Romani", "Rundi", "Romanian", "Aromanian", "Tarantino", "Pannonian Rusyn", "Russian", "Rusyn", "Aromanian", "Kinyarwanda", "Sanskrit", "Yakut", "Santali", "Sardinian", "Sicilian", "Scots", "Sindhi", "Northern Sami", "Sango", "Samogitian", "Serbo-Croatian", "Tachelhit", "Shan", "Shawiya", "Sinhala", "Simple English", "Slovak", "Saraiki", "Slovenian", "Samoan", "Inari Sami", "Shona", "Somali", "Albanian", "Serbian", "Sranan Tongo", "Swati", "Southern Sotho", "Saterland Frisian", "Sundanese", "Swedish", "Swahili", "Sylheti", "Silesian", "Sakizaya", "Tamil", "Atayal", "Tulu", "Tai Nuea", "Telugu", "Tetum", "Tajik", "Thai", "Tigrinya", "Tigre", "Turkmen", "Tagalog", "Talysh", "Tswana", "Tongan", "Toki Pona", "Tok Pisin", "Turkish", "Taroko", "Tsonga", "Tatar", "Tumbuka", "Twi", "Tahitian", "Tuvinian", "Udmurt", "Uyghur", "Ukrainian", "Urdu", "Uzbek", "Venda", "Venetian", "Veps", "Vietnamese", "West Flemish", "Volapük", "Võro", "Walloon", "Waray", "Wolof", "Wu", "Kalmyk", "Xhosa", "Mingrelian", "Yiddish", "Yoruba", "Cantonese", "Zhuang", "Zeelandic", "Standard Moroccan Tamazight", "Chinese", "Literary Chinese", "Minnan", "Cantonese", "Zulu");
    public static Map<String, String> localNames = new HashMap<String, String>();
    private static int waitTime = 800;
...
//        scrapWikipedia(1);
    ...
    public static void scrapLanguage(String code)
    {
        long startTime = System.currentTimeMillis();
        String body = getData(code);
        ...
        WebScrapperGui.addLog(localNames.get(code) + ": " + (duration - waitTime) + " ms");
    }

    public static void scrapWikipedia(int articlesPerLanguage, String language)
    {
        if(isRunning)
        {
        ...
        for(int i = 0; i < articlesPerLanguage; i++)
        {
            if(language.equals("All"))
            {
                ...
                {
                    scrapLanguage(languageCodes.get(j));
                }
            }
            else
            {
                scrapLanguage(language);
            }
